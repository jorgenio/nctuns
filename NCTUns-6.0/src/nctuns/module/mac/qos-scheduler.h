...
class QosScheduler{
 ...
 public:
	...
	virtual int    	reg_TSPEC(u_char *mac, char *tspec, enum pro_ proto){return 0;}		/* Register a Traffic Stream */
	virtual void	delete_TS(u_char *mac, u_char direction, u_char tsid){}  /* delete a registed TS */
