...
bool ChannelCoding_80211p::CC_EncoderTableInitiated = false;
bool ChannelCoding_80211p::CC_EncoderTableDeleted = false;
bool ChannelCoding_80211p::CC_DecoderTableInitiated = false;
bool ChannelCoding_80211p::CC_DecoderTableDeleted = false;
struct EncoderLookupEntry *ChannelCoding_80211p::CC_1_2_EncoderTable = NULL;
struct EncoderLookupEntry *ChannelCoding_80211p::CC_2_3_EncoderTable = NULL;
struct EncoderLookupEntry *ChannelCoding_80211p::CC_3_4_EncoderTable = NULL;
struct DecoderLookupEntry *ChannelCoding_80211p::CC_1_2_DecoderTable = NULL;
struct DecoderLookupEntry *ChannelCoding_80211p::CC_2_3_DecoderTable = NULL;
struct DecoderLookupEntry *ChannelCoding_80211p::CC_3_4_DecoderTable = NULL;

ChannelCoding_80211p::ChannelCoding_80211p(bool isEnabled)
{
...
//		printf("Bypassing Channel Coding...\n");
	...
	CC_1_2 = new ConvoCode_(0133, 0171, 7, 01, 01, 1);
	CC_2_3 = new ConvoCode_(0133, 0171, 7, 02, 03, 2);
	CC_3_4 = new ConvoCode_(0133, 0171, 7, 05, 06, 3);
...
ChannelCoding_80211p::~ChannelCoding_80211p()
{
	//printf("ChannelCoding_80211p::~ChannelCoding_80211p()\n");
...
int ChannelCoding_80211p::max(int a,int b)
{
	if (a >= b)
	return a;
	else	return b;
}
int ChannelCoding_80211p::encode(char *input, char *output, int inputLen,
			  int codeType)
{
...
#if DEBUG_CHANNEL_CODING
	printf("===========================================\n");
	printf("ChannelCoding_80211p::encode()\n");
	printf("\tinputLen = %d\n", inputLen);
...
int ChannelCoding_80211p::decode(char *input, char *output, int inputLen,
			  int codeType)
{
	int uncodedBlockSize = coding[codeType].uncodedBlockSize;
	int codedBlockSize = coding[codeType].codedBlockSize;
	...
	printf("===========================================\n");
	printf("ChannelCoding_80211p::decode()\n");
	printf("\tinputLen = %d\n", inputLen);
	printf("\tuncoded = %d, coded = %d\n", uncodedBlockSize,
	       codedBlockSize);
	printf("\tnumBlocks = %d\n", numBlocks);
...
int ChannelCoding_80211p::getUncodedBlockSize(int codeType)
{
	return coding[codeType].uncodedBlockSize;
}

int ChannelCoding_80211p::getCodedBlockSize(int codeType)
{
	return coding[codeType].codedBlockSize;
}

int ChannelCoding_80211p::getUncodedBurstLen(int codedBurstLen, int codeType)
{
	int uncodedBlockSize = coding[codeType].uncodedBlockSize;
	int codedBlockSize = coding[codeType].codedBlockSize;
...
int ChannelCoding_80211p::getCodedBurstLen(int uncodedBurstLen, int codeType)
{
	int uncodedBlockSize = coding[codeType].uncodedBlockSize;
	int codedBlockSize = coding[codeType].codedBlockSize;
...
void ChannelCoding_80211p::initCoding(int uncodedBlockSize, int codedBlockSize,
...
void ChannelCoding_80211p::randomize(char *input, char *output, int inputLen)
{
...
void ChannelCoding_80211p::derandomize(char *input, char *output, int inputLen)
{
	randomize(input, output, inputLen);
}

void ChannelCoding_80211p::interleave(char *input, char *output, int codeType)
{
...
void ChannelCoding_80211p::deinterleave(char *input, char *output, int codeType)
{
	int Ncbps = coding[codeType].Ncbps;
	int Nbpsc = coding[codeType].Nbpsc;
	int s = max(Nbpsc/2 ,1);        //hychen modified
...
void ChannelCoding_80211p::dumpByteString(char *prompt, char *byteString, int len)
{
	int i;
