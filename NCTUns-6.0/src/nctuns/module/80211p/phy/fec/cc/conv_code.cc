...
ConvoCode_::ConvoCode_(int _GX, int _GY, int _GLen, int _PX, int _PY,
		     int _PLen)
{
...
ConvoCode_::~ConvoCode_()
{
	delete decoderState;
}

struct EncoderLookupEntry *ConvoCode_::genEncoderLookupTable()
{
...
// gets called.
struct DecoderLookupEntry *ConvoCode_::genDecoderLookupTable()
{
...
void ConvoCode_::resetEncoderState()
{
	encoderState = 0;
}

void ConvoCode_::resetDecoderState()
{
 ...
 */
int ConvoCode_::encode(char *input, char *output, int inputLen)
{
	int in;
 ...
 */
int ConvoCode_::decode(char *input, char *output, int inputLen,
		      int lookahead)
{
	int **from;
	int **metric;
