...
#ifndef __NCTUNS_fct_section_h__
#define __NCTUNS_fct_section_h__
...
#define MAX_FCT_SECTION_SIZE			1024
#define MAX_FCT_SECTION_SIZE_NO_INCLUDING_CRC32	(MAX_FCT_SECTION_SIZE - CRC32_SIZE)
 ...
 * multiple sections.
 */
class Fct_table_to_section_handler {
  private:
	...
	void				_calculate_last_section_number_and_section_lengths(Fct* Fct_table);

  public:
	void				fct_table_to_section_init(Fct* Fct_table);
	void*				fct_table_to_section();
 ...
 * distinct Sct table.
 */
class Fct_section_to_table_handler {
...
#endif /* __NCTUNS_fct_section_h__ */
