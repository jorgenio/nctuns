...
#ifndef __NCTUNS_mpeg2_ts_rcst_h__
#define __NCTUNS_mpeg2_ts_rcst_h__
...
class Mpeg2_ts_rcst : public NslObject{
...
public:
	...
	Mpeg2_ts_rcst(unsigned int, unsigned int, struct plist*, const char*);
	~Mpeg2_ts_rcst();
...
#endif /* __NCTUNS_mpeg2_ts_rcst_h__ */
