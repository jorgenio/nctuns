...
#ifndef __NCTUNS_mpeg2_ts_sp_h__
#define __NCTUNS_mpeg2_ts_sp_h__
...
class Mpeg2_ts_sp : public NslObject{
...
private:
	...
	list<ePacket_*>	_ts_buf;
public:

	Mpeg2_ts_sp(unsigned int, unsigned int, struct plist*, const char*);
	~Mpeg2_ts_sp();
...
#endif /* __NCTUNS_mpeg2_ts_sp_h__ */
