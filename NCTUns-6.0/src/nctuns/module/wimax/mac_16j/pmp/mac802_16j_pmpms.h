...
#ifndef __NCTUNS_80216J_MAC_80216E_PMPMS_H__
#define __NCTUNS_80216J_MAC_80216E_PMPMS_H__
...
#include "../../phy_16j/ofdma_pmpms_MR.h"
...
class OFDMA_PMPMS_MR;

class mac802_16j_PMPMS:public mac802_16MSbase {
	private:
		enum RangingStatus {
			Init,
			Continue,
		...
		int         _DLAccessSymbols;
                int         _DLTransSymbols;
		uint16_t    RelayRSbasicid;	// indicate relayed RS BCID
		bool        RELAY_FLAG;      // indicate iff MS relayed
	...
	public:
		mac802_16j_PMPMS(uint32_t type, uint32_t id, struct plist *pl, const char *name);
		~mac802_16j_PMPMS();
		...
		friend class MS_16j_Scheduler;
		friend class OFDMA_PMPMS_MR;
};

#endif                /* __NCTUNS_80216E_MAC_80216J_PMPMS_H__ */
