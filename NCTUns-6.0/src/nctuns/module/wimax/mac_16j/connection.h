...
#ifndef __NCTUNS_80216J_CONNECTION_H__
#define __NCTUNS_80216J_CONNECTION_H__
...
namespace mobileRelayConnection {
	class Connection {
		protected:
			int crcIndicator;
			int pduqlen;
	...
	class DataConnection : public Connection {
		protected:
			Packet* _qPkt;	//for record fragmentation packet purpose
			int     _qLen;	//for record fragmentation packet purpose
...
#endif          /* __NCTUNS_80216J_CONNECTION_H__ */
