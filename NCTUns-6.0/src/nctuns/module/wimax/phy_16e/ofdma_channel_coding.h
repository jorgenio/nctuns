...
#include "fec/cc/ofdma_convo_code.h"
...
class OFDMA_ChannelCoding {
	private:
		 ...
		 */
		OFDMA_ConvoCode   *_CC_1_2;
		OFDMA_ConvoCode   *_CC_2_3;
		OFDMA_ConvoCode   *_CC_3_4;
		...
		void    initCoding      (int, int, OFDMA_ConvoCode *, int, int);
