...
OFDMA_ChannelModel::OFDMA_ChannelModel(double bandwidth, double symbolDuration, bool isEnabled)
{
...
OFDMA_ChannelModel::~OFDMA_ChannelModel()
{
	;
}

double OFDMA_ChannelModel::computeBER(int codeType, double SNR)
{
...
double OFDMA_ChannelModel::computeBERbyENR(int codeType, double ENR)
{
	double BER = 0.0;
...
void OFDMA_ChannelModel::makeBitError(char *input, int inputLen, double BER)
{
 ...
 */
double OFDMA_ChannelModel::BPSK(double ENR)
{
...
double OFDMA_ChannelModel::QPSK(double ENR)
{
	return BPSK(ENR);
}
 ...
 *   2000, p.223.
 */
double OFDMA_ChannelModel::QAM(int M, double ENR)
{
	double BER  = 0.0;
	double d    = 0.0;
	double logm = 0.0;
...
double OFDMA_ChannelModel::powerToSNR(double power)
{
 ...
 *   p.97.
 */
double OFDMA_ChannelModel::SNRToENR(double SNR, double dataRate)
{
