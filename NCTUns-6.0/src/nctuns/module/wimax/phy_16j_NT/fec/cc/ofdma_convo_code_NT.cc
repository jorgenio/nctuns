...
#include "ofdma_convo_code_NT.h"

OFDMA_ConvoCode_NT::OFDMA_ConvoCode_NT(int _GX, int _GY, int _GLen, int _PX, int _PY, int _PLen)
{
...
OFDMA_ConvoCode_NT::~OFDMA_ConvoCode_NT()
{
	delete [] decoderState;
}

struct EncoderLookupEntry *OFDMA_ConvoCode_NT::genEncoderLookupTable()
{
...
// gets called.
struct DecoderLookupEntry *OFDMA_ConvoCode_NT::genDecoderLookupTable()
{
...
void OFDMA_ConvoCode_NT::setEncoderLookupTable(struct EncoderLookupEntry *lookupTable)
{
	encoderLookupTable = lookupTable;
}

void OFDMA_ConvoCode_NT::setDecoderLookupTable(struct DecoderLookupEntry *lookupTable)
{
	decoderLookupTable = lookupTable;
}

void OFDMA_ConvoCode_NT::resetEncoderState(int state)
{
	encoderState = state;
}

int OFDMA_ConvoCode_NT::getEncoderState()
{
	return encoderState;
}

void OFDMA_ConvoCode_NT::resetDecoderState()
{
 ...
 */
int OFDMA_ConvoCode_NT::encode(char *input, char *output, int inputBits)
{
	int in;
 ...
 */
int OFDMA_ConvoCode_NT::decode(char *input, char *output, int inputBits, int lookahead)
{
	int **from;
	int **metric;
	int size = (int) pow(2, GLen - 1);    // Number of states
