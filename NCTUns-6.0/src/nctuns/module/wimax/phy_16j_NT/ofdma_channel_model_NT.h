...
#ifndef __NCTUNS_OFDMA_CHANNEL_MODEL_H__
#define __NCTUNS_OFDMA_CHANNEL_MODEL_H__
...
class OFDMA_ChannelModel_NT {
	...
	public:
		OFDMA_ChannelModel_NT(double, double, bool);
		~OFDMA_ChannelModel_NT();
...
#endif                /* __NCTUNS_OFDMA_CHANNEL_MODEL_H__ */
