...
#ifndef __NCTUNS_80216E_MAC_80216E_PMPMS_H__
#define __NCTUNS_80216E_MAC_80216E_PMPMS_H__
...
class mac802_16e_PMPMS:public mac802_16MSbase {
	private:
		char    *LinkMode;
		uint8_t myDIUC;
		int     State;
	...
	public:
		mac802_16e_PMPMS(uint32_t type, uint32_t id, struct plist *pl, const char *name);
		~mac802_16e_PMPMS();
		...
		friend class MS_16e_Scheduler;
};

#endif                /* __NCTUNS_80216E_MAC_80216E_PMPMS_H__ */
