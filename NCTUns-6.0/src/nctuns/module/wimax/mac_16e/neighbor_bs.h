...
#ifndef __NCTUNS_80216E_NEIGHBOR_BS_H__
#define __NCTUNS_80216E_NEIGHBOR_BS_H__
...
class NeighborBSs {
	public:
		...
		vector<NbrBS *> nbrBSs_Index;
		vector<NbrBS *> nbrBSs_Full;
		vector<NbrBS *> nbrBSs_Curr;

	public:
		NeighborBSs();
		~NeighborBSs();

		NbrBS *getNbrbyBSID(uint8_t *);
		NbrBS *getNbrbyChID(uint8_t);
		int getNextScanChID();
		bool checkHOterms();
		NbrBS *getTargetBS();
		void dump();
...
#endif  /* __NCTUNS_80216E_NEIGHBOR_BS_H__ */
