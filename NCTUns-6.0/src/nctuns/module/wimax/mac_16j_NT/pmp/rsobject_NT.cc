...
rsObject_NT::rsObject_NT(uint8_t *pMac, int pBasicCID, int pPriCID, int pSecCID, mac802_16j_NT_PMPBS *pBS,  mac802_16j_NT_PMPRS *pRS)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::rsObject_NT ",get_nid());
...
int rsObject_NT::handle(mgmt_msg *recvmm, int cid, int len,int cur_frame_no)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::handle ",get_nid());
...
void rsObject_NT::T7()
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::T7 ",get_nid());
...
void rsObject_NT::T10()
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::T10 ",get_nid());
	;//printf("\nrsObject_NT::%s()\n", __func__);
}
...
void rsObject_NT::T68()
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::T68 ",get_nid());
    SendRS_ConfigCMD(frame_no);
...
void rsObject_NT::ResourceClear()
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::ResourceClear ",get_nid());
...
void rsObject_NT::procSBCREQ(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procSBCREQ ",get_nid());
...
void rsObject_NT::SendDSAREQ(uint16_t cid)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::SendDSAREQ ",get_nid());
	ifmgmt *ifmm        = NULL;
	ifTLV *tmptlv       = NULL;
	uint8_t fhmac[21]   = "";
...
void rsObject_NT::SendRCD()
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::SendRCD ",get_nid());
    //ifmgmt *ifmm        = NULL;
...
void rsObject_NT::SendRS_ConfigCMD(int frame_no)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::SendRS_ConfigCMD ",get_nid());
    ifmgmt *ifmm        = NULL;
    uint8_t fhmac[21]   = "";
...
void rsObject_NT::procREGREQ(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procREGREQ ",get_nid());
	ifmgmt *ifmm_req    = NULL;
	ifmgmt *ifmm_rsp    = NULL;
	int type            = 0;
	uint8_t fmanage     = 0;
...
void rsObject_NT::procDSARSP(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procDSARSP ",get_nid());
	ifmgmt *ifmm_rsp    = NULL;
...
void rsObject_NT::procMOB_MSHOREQ(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procMOB_MSHOREQ ",get_nid());
	ifmgmt *ifmm_req            = NULL;
	ifmgmt *ifmm_rsp            = NULL;
	int ifmmLen                 = 0;
...
void rsObject_NT::procMOB_SCNREQ(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procMOB_SCNREQ ",get_nid());
	ifmgmt *ifmm_req        = NULL;
	ifmgmt *ifmm_rsp        = NULL;
	int ifmmLen             = 0;
...
void rsObject_NT::procMOB_SCNREP(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procMOB_SCNREP ",get_nid());
	ifmgmt *ifmm              = NULL;
	int ifmmLen               = 0;
	uint8_t repMode           = 0;
...
void rsObject_NT::procMOB_HOIND(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procMOB_HOIND ",get_nid());
	ifmgmt *ifmm    = NULL;
	int ifmmLen     = 0;
	uint8_t rsv     = 0;
	uint8_t Mode    = 0;
...
void rsObject_NT::procMR_GenericACK(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procMR_GenericACK ",get_nid());
    ifmgmt *ifmm     = NULL;
    //uint16_t ftransid   = 0;
...
void rsObject_NT::procDCD(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procDCD ",get_nid());
...
void rsObject_NT::procTEST(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procTEST ",get_nid());
...
void rsObject_NT::procUCD(struct mgmt_msg *recvmm, int cid, int len)
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::procUCD ",get_nid());
    //printf("\e[1;35mTime:%llu rsObject_NT::%s()\e[0m\n",GetCurrentTime(), __func__);
...
void rsObject_NT::Dump()
{
	...
	logRidvan(TRACE,"-->%d	rsObject_NT::Dump ",get_nid());
