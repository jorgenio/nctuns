...
OFDMA_ChannelModel_MR::OFDMA_ChannelModel_MR(double bandwidth, double symbolDuration, bool isEnabled)
{
...
OFDMA_ChannelModel_MR::~OFDMA_ChannelModel_MR()
{
	;
}

double OFDMA_ChannelModel_MR::computeBER(int codeType, double SNR)
{
...
double OFDMA_ChannelModel_MR::computeBERbyENR(int codeType, double ENR)
{
	double BER = 0.0;
...
void OFDMA_ChannelModel_MR::makeBitError(char *input, int inputLen, double BER)
{
 ...
 */
double OFDMA_ChannelModel_MR::BPSK(double ENR)
{
...
double OFDMA_ChannelModel_MR::QPSK(double ENR)
{
	return BPSK(ENR);
}
 ...
 *   2000, p.223.
 */
double OFDMA_ChannelModel_MR::QAM(int M, double ENR)
{
	double BER  = 0.0;
	double d    = 0.0;
	double logm = 0.0;
...
double OFDMA_ChannelModel_MR::powerToSNR(double power)
{
 ...
 *   p.97.
 */
double OFDMA_ChannelModel_MR::SNRToENR(double SNR, double dataRate)
{
