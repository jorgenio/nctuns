...
#ifndef __NCTUNS_80216J_OFDMA_80216J_H__
#define __NCTUNS_80216J_OFDMA_80216J_H__
...
#include "../mac_16j/management_message.h"

#define LOG_DEBUG 0

class OFDMA_ChannelCoding_MR;
class OFDMA_ChannelModel_MR;

extern RegTable         RegTable_;
extern const double     frameDuration_MR[];
extern const int        repeat_times_MR[];
...
class OFDMA_80216j:public NslObject {
	protected:
		int     frameDuCode;
		double  BW;
		double  n;
		...
		OFDMA_ChannelCoding_MR   *_channelCoding;
		OFDMA_ChannelModel_MR    *_channelModel;
	...
	public:
		OFDMA_80216j(uint32_t, uint32_t, struct plist *, const char *);
		~OFDMA_80216j();
		...
		void    setDLTransparentSymbols      (int);
		void    setULAccessSymbols	(int);
		void    setULRelaySymbols      (int);
};

#endif                /* __NCTUNS_OFDMA_80216J_H__ */
