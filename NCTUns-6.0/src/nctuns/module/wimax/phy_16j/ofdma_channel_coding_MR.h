...
#ifndef __NCTUNS_80216J_OFDMA_CHANNEL_CODING_MR_H__
#define __NCTUNS_80216J_OFDMA_CHANNEL_CODING_MR_H__
...
#include "fec/cc/ofdma_convo_code_MR.h"
...
class OFDMA_ChannelCoding_MR {
	private:
		 ...
		 */
		OFDMA_ConvoCode_MR   *_CC_1_2;
		OFDMA_ConvoCode_MR   *_CC_2_3;
		OFDMA_ConvoCode_MR   *_CC_3_4;
		...
		void    initCoding      (int, int, OFDMA_ConvoCode_MR *, int, int);
	...
	public:
		OFDMA_ChannelCoding_MR        (bool);
		~OFDMA_ChannelCoding_MR       ();
...
#endif                /* __NCTUNS_80216J_OFDMA_MR_CHANNEL_CODING_H__ */
