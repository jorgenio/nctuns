...
#include "ofdma_convo_code_MR.h"

OFDMA_ConvoCode_MR::OFDMA_ConvoCode_MR(int _GX, int _GY, int _GLen, int _PX, int _PY, int _PLen)
{
...
OFDMA_ConvoCode_MR::~OFDMA_ConvoCode_MR()
{
	delete [] decoderState;
}

struct EncoderLookupEntry *OFDMA_ConvoCode_MR::genEncoderLookupTable()
{
...
// gets called.
struct DecoderLookupEntry *OFDMA_ConvoCode_MR::genDecoderLookupTable()
{
...
void OFDMA_ConvoCode_MR::setEncoderLookupTable(struct EncoderLookupEntry *lookupTable)
{
	encoderLookupTable = lookupTable;
}

void OFDMA_ConvoCode_MR::setDecoderLookupTable(struct DecoderLookupEntry *lookupTable)
{
	decoderLookupTable = lookupTable;
}

void OFDMA_ConvoCode_MR::resetEncoderState(int state)
{
	encoderState = state;
}

int OFDMA_ConvoCode_MR::getEncoderState()
{
	return encoderState;
}

void OFDMA_ConvoCode_MR::resetDecoderState()
{
 ...
 */
int OFDMA_ConvoCode_MR::encode(char *input, char *output, int inputBits)
{
	int in;
 ...
 */
int OFDMA_ConvoCode_MR::decode(char *input, char *output, int inputBits, int lookahead)
{
	int **from;
	int **metric;
	int size = (int) pow(2, GLen - 1);    // Number of states
