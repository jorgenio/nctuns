...
#ifndef __NCTUNS_80216J_OFDMA_CONVO_CODE_MR_H__
#define __NCTUNS_80216J_OFDMA_CONVO_CODE_MR_H__
...
class OFDMA_ConvoCode_MR {
	...
	public:
		OFDMA_ConvoCode_MR(int _GX, int _GY, int _GLen, int _PX, int _PY, int _PLen);
		~OFDMA_ConvoCode_MR();
...
#endif                /* __NCTUNS_80216J_OFDMA_CONVO_CODE_MR_H__ */
