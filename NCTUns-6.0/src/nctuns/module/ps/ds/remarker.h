...
#ifndef __NCTUNS_DS_REMARKER_h__
#define __NCTUNS_DS_REMARKER__
...
class Remarker : public NslObject {
 ...
 public:
	...
	Remarker(u_int32_t type, u_int32_t id,struct plist *pl, const char *name);
	~Remarker();
