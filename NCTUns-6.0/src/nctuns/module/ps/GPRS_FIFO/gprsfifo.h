...
#ifndef __NCTUNS_GPRSfifo_h__
#define __NCTUNS_GPRSfifo_h__
...
class GPRSfifo : public NslObject {
 ...
 public:
	...
	GPRSfifo(u_int32_t type, u_int32_t id, struct plist* pl, const char *name);
	~GPRSfifo();
