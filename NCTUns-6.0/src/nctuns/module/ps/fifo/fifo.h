...
#ifndef __NCTUNS_fifo_h__
#define __NCTUNS_fifo_h__
...
class fifo : public NslObject {
 ...
 public:
	...
	fifo(u_int32_t type, u_int32_t id, struct plist* pl, const char *name);
	~fifo();
