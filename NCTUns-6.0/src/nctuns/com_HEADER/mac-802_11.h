...
#ifndef	__NCTUNS_mac_802_11_h__
#define __NCTUNS_mac_802_11_h__
...
#define MAC_Subtype_Action		0x0d	/* QoS Action Field */
...
struct hdr_mac802_11 {
	...
	/* hwchu:
	 *   dh_addr4 is only needed in WDS, which is not supported in the
	 *   current version.
	 */
