...
int main(int argc, char **argv) {
	...
	SetCapabilityInfoInto80211eReassociationResponseFrameBody(framebody, ESS, IBSS, CFPollable, CFPollRequest, Privacy, ShortPreamble, PBCC, ChannelAgility, SpectrumManagement, QoS, ShortSlotTime, APSD, DSSS_OFDM, DelayedBloackAck, ImmediateBlockAck);
	if(ESS)
	...
	StatusCode = 2;
	SetStatusCodeInto80211eReassociationResponseFrameBody(framebody, &StatusCode);
	printf("\e[0;31;40mSet\e[m StatusCode = %d\n", StatusCode);

	AID = 12;
	SetAIDInto80211eReassociationResponseFrameBody(framebody, &AID);
	...
	SetSupportedRatesInto80211eReassociationResponseFrameBody(framebody, SupportedRates_Len, (void *)SupportedRates);
	...
	/*==Get=========================*/
	CapabilityInfo = GetCapabilityInfoFrom80211eReassociationResponseFrameBody(framebody);
	...
	GetStatusCodeFrom80211eReassociationResponseFrameBody(framebody, &StatusCode);
	printf("\e[0;32;40mGet\e[m StatusCode = %d\n", StatusCode);

	GetAIDFrom80211eReassociationResponseFrameBody(framebody, &AID);
	printf("\e[0;32;40mGet\e[m AID = %d\n", AID);

	tmp_void_ptr = GetSupportedRatesFrom80211eReassociationResponseFrameBody(framebody, &SupportedRates_Len);
	...
	tmp_char_ptr = GetEDCAParameterSetFrom80211eReassociationResponseFrameBody(framebody, SupportedRates_Len);
