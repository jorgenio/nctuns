...
int main(int argc, char **argv) {
	...
	/* Build frame body */
	framebody_len = Calculate80211eDeauthenticationFrameBodyLength();
	...
	ReasonCode = 8;
	SetReasonCodeInto80211eDeauthenticationFrameBody(framebody, &ReasonCode);
	printf("\e[0;31;40mSet\e[m ReasonCode = %d\n", ReasonCode);

	/*==Get=========================*/
	GetReasonCodeFrom80211eDeauthenticationFrameBody(framebody, &ReasonCode);
