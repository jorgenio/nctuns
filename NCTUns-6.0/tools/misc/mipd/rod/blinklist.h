...
int                     printBList(BLLIST *);
int                     freeBList(BLLIST *);

struct blinkListEntry * newBListEntry(char *, char *);
struct blinkListEntry * newBListEntry2(struct in_addr *, struct in_addr *);
int                     addBEntry(BLLIST *, char *, char *);
int                     addBEntry2(BLLIST *, struct in_addr *, struct in_addr *);
int                     delBEntry(BLLIST *);
...
struct in_addr *        searchBEntry(BLLIST *, struct in_addr *);
