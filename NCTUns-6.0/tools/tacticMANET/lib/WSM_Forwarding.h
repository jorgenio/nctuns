...
#define ForwardingPort		5000
//#define CMD_SERVER_TRIGER	100000

int             mynid, myTCPsockfd, socketfd2, forwardingUDPfd;
int		packet_send_period, bind_port;
pid_t           pid;
char 		*AppWsmData;
int		WSM_ahead_recv;
...
void forwardWSM(int myTCPsockfd, struct WaveShortMessageProtocol &wsmp_header, char *WSM_Data);
